...
@Component({
  selector: 'app-outer-treemap',
  templateUrl: './outer-treemap.component.html',
  styleUrls: ['./outer-treemap.component.css']
})
export class OuterTreemapComponent {
  graphing = true;
  ...
  createChart() {
    this.treemapChart = echarts.init(document.getElementById('outer-treemap') as HTMLDivElement);
